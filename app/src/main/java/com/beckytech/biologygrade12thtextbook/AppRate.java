...
public class AppRate {
    private final static String APP_TITLE = "Biology Textbook Grade 12th";// App Name
    private static final String APP_PNAME = "com.beckytech.biologygrade12thtextbook";// Package Name
